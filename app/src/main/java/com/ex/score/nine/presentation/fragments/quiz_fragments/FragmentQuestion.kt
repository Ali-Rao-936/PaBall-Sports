...
class FragmentQuestion : Fragment() {
    ...
    lateinit var teamAnswersList: ArrayList<AnswersModel>
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        teamsQuestionsList = MainActivity.matchesList
        suggestionsTeamNamesList = MainActivity.suggestionTeamsList
...
//            }
    ...
    private fun setNumberOfPointsCollect() {
        ...
        question_number?.text = activity?.resources?.getString(R.string.question_number) + " " + getCorrectAnswerFromSP(
            activity?.applicationContext
        )
        qp_number_tv?.text = activity?.resources?.getString(R.string.qp) + " " + java.lang.String.valueOf(
            i
        )
    ...
    fun setTeamDetails(team : TeamInfo){
  ...
  fun  setPlayerDetails(player : PlayerBio){
