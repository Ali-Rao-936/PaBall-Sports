...
import com.pa.ball.sports.quiz.domain.models.Map;
        ...
        if (checkIfAndroidVBiggerThan9()) {
            ...
            try {
                ...
                try {
                    ...
                    ListResponse.adsArrayList = new ArrayList<>();
                    ListResponse.mapArrayList = new ArrayList<>();
                    ...
                    ListResponse.prompt_frequency = prompt.getString("frequency");
                    ListResponse.prompt_title = prompt.getString("title");
                    ListResponse.prompt_message = prompt.getString("message");
...
//                    Log.i("TAG","prompt_message: "+prompt_message);
                    ...
                    for (int i = 0; i < separated.length; i++) {
                        ...
                        ListResponse.mapArrayList.add(map1);
...
//                        Log.i("TAG","Map_link: "+map1.getMap_link());
                    ...
                    for (int i = 0; i < bannerArray.length(); i++) {
                        ...
                        ListResponse.adsArrayList.add(new Ads(
