package com.pa.ball.sports.quiz.utils

import android.content.Context
import androidx.datastore.core.DataStore
import androidx.datastore.preferences.core.*
import com.pa.ball.sports.quiz.domain.models.AnswersModel
import com.pa.ball.sports.quiz.domain.models.PlayerBio
import com.pa.ball.sports.quiz.domain.models.TeamInfo
...
object Utils {
    ...
    fun getLocale(context: Context): String {
        return SharedPreference.getInstance().getStringValueFromPreference(
            ...
            SharedPreference.ENGLISH,context)
    }
