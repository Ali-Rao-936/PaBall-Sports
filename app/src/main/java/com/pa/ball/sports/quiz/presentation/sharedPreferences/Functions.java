...
import static com.pa.ball.sports.quiz.presentation.sharedPreferences.PromptFrequency.getPromptFrequencyFromSP;
import static com.pa.ball.sports.quiz.presentation.sharedPreferences.PromptFrequency.savePromptFrequencyInSP;
...
import com.pa.ball.sports.quiz.domain.models.AnswersModelT;
...
public class Functions {
    ...
    public static boolean showPopupMessageCheck(Context context) {
        ...
        if (ListResponse.prompt_frequency == null || ListResponse.prompt_frequency.isEmpty()) {
            canOrCant = false;
        } else {
            int y = Integer.parseInt(ListResponse.prompt_frequency);
            if (x > y) {
                canOrCant = false;
            } else {
                canOrCant = true;
